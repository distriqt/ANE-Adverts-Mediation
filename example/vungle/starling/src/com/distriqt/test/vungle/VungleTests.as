 ...
 * @created		10/10/2024
 */
package com.distriqt.test.vungle
{
	import com.distriqt.extension.admob.vungle.Vungle;
	...
	import com.distriqt.extension.vungle.Vungle;
	...
	/**	
	 */
	public class VungleTests extends Sprite
	{
		...
		public function VungleTests( logger:ILogger )
		{
			_l = logger;
		}
		...
		public function init():void
		{
			try
			{
				try
				{
					...
					log( "Vungle Version:         " + Vungle.service.version );
					log( "Vungle Native Version:  " + Vungle.service.nativeVersion );
